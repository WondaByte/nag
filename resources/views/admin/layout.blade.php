    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('addgeo')  }}">
              <span class="menu-icon">
                <i class="mdi mdi-texture"></i>
              </span>
              <span class="menu-title">Add Geo Data</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('viewdata') }}">
              ...
              <span class="menu-title">View All Geo Data </span>
            </a>
          </li>
 ...
 @yield('content')
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a href="https://www.nagaiconsults.com" target="_blank">NAGAI CONSULTS LIMITED</a>. All rights reserved.</span>
